...
public class RequestLogService {
  ...
  private static final String COLUMNS =
      "id AS request_id,http_request_id,application_id,operation,state,outcome,error_code,created_at,completed_at,expires_at,application_revision,configuration_id,application_configuration_id";
